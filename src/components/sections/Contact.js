...
const Contact = ({ language }) => {
  const { head, phone, email, address, followMe } = useSetContent(contact, language);
      ...
      <div className="boxes">
        <div>
          ...
          <div className="animated-layer fade-in-down-animation fadeInUp wow">
            ...
            <p>
              <span className="small-text">{phone[0]}</span>
              {phone[1]}
            </p>
          </div>
          {/* CONTACT ITEM ENDS */}
          ...
          <div className="animated-layer fade-in-up-animation fadeInUp wow">
            ...
            <p>
              <span className="small-text">{address[0]}</span>
              {address[1]}
            </p>
          </div>
          {/* CONTACT ITEM ENDS */}
        ...
        <div>
          ...
          <div className="animated-layer fade-in-down-animation fadeInUp wow">
            ...
            <p>
              <span className="small-text">{email[0]}</span>
              {email[1]}
            </p>
          </div>
          {/* CONTACT ITEM ENDS */}
          ...
          <div className="animated-layer fade-in-up-animation fadeInUp wow">
            ...
            <span className="small-text">{followMe[0]}</span>
            <ul className="social">
              <li>
                <a href={followMe[1]} target="_blank">
